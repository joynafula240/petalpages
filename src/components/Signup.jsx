...
import { BookOpen, Mail, Lock, User, Eye, EyeOff, ArrowRight, ArrowLeft } from 'lucide-react';
...
const Signup = ({ onSignup, onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Get existing users from localStorage (in real app, this would be server-side)
      ...
      // Save user
      users.push(newUser);
      localStorage.setItem('petalPagesUsers', JSON.stringify(users));

      // Initialize user's book data
      localStorage.setItem(`petalPagesBooks_${newUser.id}`, JSON.stringify([]));
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-[#c1bddb]/20">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#2d3047] mb-2">Create Account</h1>
            <p className="text-[#2d3047]/70 text-sm">Join our reading community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#c1bddb]" />
                <input
                  type="text"
                  value={name}
